...
1. - Server & Brave communicate using HTTP protocol, Network tab in dev console (f12) shows this.
2. - GET method
3. - Request successful is Status code 200
4. - The server can form HTML documents dynamically according to the application's code, for example using data from a database
...
2. - https://developer.mozilla.org/en-US/docs/Web/HTTP/Reference/Methods/GET
